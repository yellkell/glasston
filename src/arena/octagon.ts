/**
 * Geometry helpers for the octagonal play space.
 */
 ...
 * vertices in the floor plane. The resulting geometry lies in the XZ plane with
 * its top face at y = `thickness` and bottom at y = 0.
 */
